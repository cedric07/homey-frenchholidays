...
Chaque nuit (vers 00h05 heure de Paris), l'app recalcule « est-ce vacances aujourd'hui ? », « férié demain ? », etc. à partir de ce cache, et déclenche vos Flows si un événement change : début ou fin de vacances scolaires, jour férié aujourd'hui ou demain.
...
Cartes Flow :
- Conditions : vacances scolaires, jour férié, jours avant prochaines vacances/férié
- Déclencheurs : début/fin des vacances, férié aujourd'hui/demain
