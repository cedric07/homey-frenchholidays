...
class DayInfoService {
  ...
  _translateSnapshotLabels(snapshot, lang) {
    ...
    if (translated.publicHoliday.yesterdayLabel) {
      translated.publicHoliday.yesterdayLabel = translateLabel(translated.publicHoliday.yesterdayLabel, lang);
    }
    ...
    if (translated.schoolHoliday.yesterdayLabel) {
      translated.schoolHoliday.yesterdayLabel = translateLabel(translated.schoolHoliday.yesterdayLabel, lang);
    }
    if (translated.schoolHoliday.tomorrowLabel) {
      translated.schoolHoliday.tomorrowLabel = translateLabel(translated.schoolHoliday.tomorrowLabel, lang);
    }
    return translated;
  }
